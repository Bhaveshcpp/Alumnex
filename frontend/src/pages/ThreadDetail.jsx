...
export default function ThreadDetail() {
  ...
  const getDifficultyColor = (difficulty) => {
    ...
    return (
      colors[difficulty?.toLowerCase()] || "bg-gray-100 text-gray-800"
    );
  };
    ...
    📋 Copy Link
        ...
        <article className="bg-white border border-gray-200 rounded-lg p-8">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-500 mt-1">
                {current.jobRole?.title || "Position"}
              </p>
            </div>
          ...
          {current.topicsCovered &&
            Array.isArray(current.topicsCovered) &&
            current.topicsCovered.length > 0 && (
              <div className="mt-8">
